...
// export const BOARD_SQUARE_SELECTED = ;
// export const BOARD_SQUARE_MOVABLE = 'rgba(141, 199, 83, 0.8)';
// export const BOARD_SQUARE_CAPTURABLE = 'rgba(199, 83, 141, 0.8)';
// export const BOARD_SQUARE_CHECK = 'red';
